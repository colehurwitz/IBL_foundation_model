...
def co_smoothing_eval(
    ...
    if is_aligned:
        ...
        #                    'reward': {(0.,): "no reward",
        #                               (1.,): "reward", }}
        var_value2label = {'choice': {(-1.0,): "right",
                                      (1.0,): "left"}}
    ...
    if mode == 'per_neuron':
        ...
        bps_result_list, r2_result_list, fr_list = [float('nan')] * tot_num_neurons, [np.array([np.nan, np.nan])] * N, [float('nan')] * N
...
def viz_single_cell(X, y, y_pred,
                    var_name2idx, var_tasklist, var_value2label, var_behlist,
